...
The dataset that will be getting used for this project is from [Kaggle](https://www.kaggle.com/harlfoxem/housesalesprediction) as the House Sales in King County.

![King County Washington](https://user-images.githubusercontent.com/48660919/69501500-98a41580-0ed3-11ea-9a6f-bea3a3601fbe.jpg)

## Motivation for Project

This is the first project that I'm doing from the Flatiron School Online Data Science bootcamp and so the choice of project wasn't entirely given to me. But the projects motivation is to find three questions that could be answered or given some clarity based on the analysis work that I complete.

## Goals

The goal of the project is to answer three questions that I provide for the project

### Question 1: 

What relationship is shared between the year the house was built and it's grade?¶

![Violin Plot Q1](https://user-images.githubusercontent.com/48660919/69501498-95108e80-0ed3-11ea-81af-5a11ed763a06.PNG)
